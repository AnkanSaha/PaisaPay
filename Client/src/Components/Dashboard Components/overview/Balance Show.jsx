			...
			<div className="w-full ml-10 max-w-[25rem] mt-10 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
				<div className="flex flex-col items-center pb-10">
					...
					<div className="flex flex-wrap space-x-2">
						<h5 className="mb-1 text-xl font-extrabold text-gray-900 dark:text-white mt-5">{Decoded_Account_Details.PaymentID.toUpperCase()}</h5>
						<Button
							onClick={e => {
					...
					<span className="text-xl text-gray-500 dark:text-gray-400"> Available Balance: ₹{Balance.toFixed(2)}</span>
