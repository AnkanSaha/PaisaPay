        ...
        <>
            <div className="w-full ml-10  max-w-[25rem] mt-10 px-5 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div className="flex flex-col items-center space-y-6 py-5">
                    ...
                    <InputGroup size="md">
                        <Input pr="4.5rem" type={show ? 'text' : 'password'} placeholder="Enter Current Password" value={PasswordInfo.CurrentPassword} name='CurrentPassword' onChange={handleChange} />
                    ...
                    <InputGroup size="md">
                        <Input pr="4.5rem" type={show ? 'text' : 'password'} placeholder="Enter New Password" value={PasswordInfo.NewPassword} name='NewPassword' onChange={handleChange} />
                        <InputRightElement width="4.5rem">
                            <Button h="1.75rem" size="sm" onClick={handleClick}>
                                {show ? 'Hide' : 'Show'}
                            </Button>
                    ...
                    <InputGroup size="md">
                        <Input pr="4.5rem" type={show ? 'text' : 'password'} placeholder="Enter New Password Again" value={PasswordInfo.ConfirmNewPassword} name='ConfirmNewPassword' onChange={handleChange} />
                        <InputRightElement width="4.5rem">
                            <Button h="1.75rem" size="sm" onClick={handleClick}>
                                {show ? 'Hide' : 'Show'}
                            </Button>
