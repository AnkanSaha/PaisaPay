...
import {
  ...
  Button,
  useToast,
} from "@chakra-ui/react"; // Import Heading
...
export default function WithdrawalForm() {
  ...
  return (
    <div>
      <Heading className="text-center text-cyan-700 mt-[2rem]">
      ...
      <div className="mx-48 mt-10">
        <FormControl isRequired>
          ...
          <Input
            ...
            value={WithdrawalDetails.ClientID}
            disabled
          />
          ...
          <Input
            ...
            value={WithdrawalDetails.PaymentID}
            disabled
          />
          <FormLabel>
            Client Name (Bank Account Holder Name should be same)
          </FormLabel>
          <Input
            name="Name"
            className="mb-5"
