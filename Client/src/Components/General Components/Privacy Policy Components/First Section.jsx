  ...
  return (
    <>
      ...
      <p className="text-justify lg:mx-32 mx-5 mt-[2.25rem]">
        Welcome to {AppDetails.App_Name}. This Privacy Policy outlines how we
        collect, use, disclose, and safeguard your personal information when you
        use our website and services, accessible via &nbsp;
        <Link
          to="/"
          className="bg-cyan-600 text-white px-2 py-1 rounded-lg font-bold"
        >
          Official Site
        </Link>
      ...
      <p className="text-justify lg:mx-32 mx-5 mt-[2.25rem]">
        ...
        accessing or using {AppDetails.App_Name}, you acknowledge that you have read,
        understood, and agree to the terms of this Privacy Policy. If you do not
        agree with our practices, please do not use {AppDetails.App_Name}.
      </p>
    </>
  );
}
