...
import UserProfile from '@page/Dashboard Pages/User Profile'; // import the user profile page
import RequestMoney from '@page/Dashboard Pages/Request Money'; // import the request money page
