...
export default function DashboardErrorHandler () {
  ...
  return InternetStatus === false ? <LoadingScreen /> : AccountDetails === null ? <LoginPage /> : <DashboardRouter /> // if the user is not logged in then display the not logged in component
