   ...
   <>
      ...
      <div className="lg:mt-[7rem] mt-[5.25rem] px-10">
        ...
        <div className="chat chat-end" data-aos="fade-left">
          <div className="chat-bubble">
            {" "}
            Yes, There Is A Simple Way To Send Money <br /> Just Sign Up And
            Start Sending Money
          </div>
        </div>
        {/* Second  */}
      ...
      <div className="lg:mt-[7rem] mt-[5.25rem] px-10">
        ...
        <div className="chat chat-end" data-aos="fade-left">
          <div className="chat-bubble">
            {" "}
            Yes, It's Free To Sign Up <br /> Just Click On The Get Started
            Button <br /> but there is only a small fee when you add money to
            your account
          </div>
        </div>
      </div>
