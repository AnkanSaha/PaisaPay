...
export default function NotLoggedIn_Offline({
  ...
  // Updaters
  Update_Document_Title(
    `${Status} - ${ReduxState.GeneralAppInfo.AppDetails.Static_Details.App_Name}`
    ...
    <>
      ...
      <div data-aos="fade-up">
        ...
        <p className="text-center hidden lg:block lg:mt-5 lg:text-lg font-semibold lg:mx-80">
          ...
          <a
            className="bg-cyan-700 text-white px-3 py-1 rounded-full"
...
NotLoggedIn_Offline.defaultProps = {
    ...
    Message: "Seems like No User Logged In. Please login with your account, to continue using the app. without login you cannot use the app. please login to continue using the app.",
