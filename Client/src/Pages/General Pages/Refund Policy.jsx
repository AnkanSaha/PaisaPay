    ...
    <>
      ...
      <div className='bg-gray-100 min-h-screen flex items-center justify-center mx-10'>
        <div className='bg-white p-8 rounded shadow-md'>
          ...
          <p className='mb-4'>We regret to inform you that we do not offer refunds for any purchases made through our platform.</p>
          <p className='mb-4'>Once a purchase is made, it is considered final, and no refunds will be provided, regardless of the circumstances.</p>
          <p className='mb-4'>
            If you have any questions or concerns about a specific purchase or encounter any issues, please don't hesitate to contact our customer support
