export default {
	...
	TransactionType: { type: String, required: true, default: 'Add Funds', enum: ['Add Funds', 'Withdraw Funds', 'Transfer Funds', 'Payment'], unique: false },
	...
	TransactionStatus: {
		...
		unique: false,
		enum: ['Transaction Success', 'Pending', 'Transaction Failed', 'Cancelled', 'Processing'],
	},
