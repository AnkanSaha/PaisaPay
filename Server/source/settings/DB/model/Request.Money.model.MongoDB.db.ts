export default {
    ...
    TransactionDate: {type: Date, required: true, unique: false, default: Date.now()},
    TransactionType: {type: String, required: true, unique: false, default: "Request Money"},
    ...
    TransactionDescription: {type: String, required: true, unique: false, default: "No description provided."},
    TransactionMethod: {type: String, required: true, unique: false, default: "PaisaPay Wallet", enum: ["PaisaPay Wallet"]},
    TransactionCurrency: {type: String, required: true, unique: false, default: "INR", enum: ["INR"]},
